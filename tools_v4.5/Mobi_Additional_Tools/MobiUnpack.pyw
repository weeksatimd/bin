...
class MainDialog(Tkinter.Frame):
    ...
    def mobirdr(self, infile, outdir):
        # os.putenv('PYTHONUNBUFFERED', '1')
        cmdline = 'python ./lib/mobiunpack.py "' + infile + '" "' + outdir + '"'
        if sys.platform[0:3] == 'win':
            ...
            if search_path.find('python') >= 0: 
                ...
                cmdline = 'lib\mobiunpack.py "' + infile + '" "' + outdir + '"'
    ...
    def get_mobipath(self):
        ...
        mobipath = tkFileDialog.askopenfilename(
            ...
            initialdir=cwd,
            initialfile=None,
            defaultextension='.prc', filetypes=[('Mobi PRC eBook File', '.prc'), ('Mobi AZW eBook File', '.azw'), ('Mobi eBook File', '.mobi'),
                                                ('All Files', '.*')])
        if mobipath:
    ...
    def convertit(self):
        ...
        self.p2 = self.mobirdr(mobipath, outdir)
